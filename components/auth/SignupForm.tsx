...
export default function SignupForm() {
  ...
  async function handleOAuth(provider: OAuthProvider) {
    ...
    // success হলে ব্রাউজার redirect হয়ে যাচ্ছে — loading state আনসেট
    // করার দরকার নেই।
  }

  // Google One Tap দিয়ে সাইন-আপ/সাইন-ইন সফল হলে কল হয়। SignupForm-এ
  // onboarding step machinery (worlds/tour/achievement) নেই — সেটা শুধু
  // LoginForm-এ আছে — তাই নতুন user হলে সেখানেই পাঠিয়ে দেওয়া হয়, ঠিক
  // যেভাবে button-based Google signup /auth/callback হয়ে /login?onboarding=1
  // এ ফেরত আসে।
  function handleOneTapNewUser(_newUserId: string, newUserFirstName: string) {
    router.push(
      `/login?onboarding=1&name=${encodeURIComponent(newUserFirstName)}`
    );
  }
